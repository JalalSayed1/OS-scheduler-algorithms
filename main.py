...
quantum = 0.5
context_switch_time = 0.0 # time to switch from an event to another or process to another (not sure)
...
# overwrite the default values to either new values (if user defined specific values in command line)
# OR to the "default" value (which is the same as the previous value):
...
print("-----")
print(simulators[0].full_name() + ":")
logging.info("--- " + simulators[0].full_name() + " ---")
simulators[0].run(seed)
simulators[0].print_statistics()
# run simulators
